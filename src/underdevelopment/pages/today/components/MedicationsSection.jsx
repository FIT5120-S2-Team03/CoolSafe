        ...
        return (
          <button
            ...
            style={{
              ...
              border: `1.5px solid ${selected ? BLUE : '#E5E3DF'}`,
              borderRadius: 12,
              padding: '14px 16px',
              cursor: 'pointer',
              textAlign: 'left',
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.borderColor = selected ? BLUE : 'rgba(0,0,0,0.2)'
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'none'
              e.currentTarget.style.boxShadow = selected ? '0 4px 12px rgba(24,82,180,0.08)' : '0 4px 12px rgba(34,30,26,0.02)'
              e.currentTarget.style.borderColor = selected ? BLUE : '#E5E3DF'
            }}
          >
            <span
              className="material-symbols-outlined"
              style={{ fontSize: 20, color: selected ? BLUE : '#6E6358', flexShrink: 0 }}
            >
              {MED_ICONS[med] ?? 'pill'}
            </span>
            <span
